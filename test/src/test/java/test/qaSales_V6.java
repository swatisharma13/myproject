...
public static String javaScript = "var evObj = document.createEvent('MouseEvents');" +
	...
	@Test(dataProvider = "salesQAV6-data-provider", priority =1)
	public static void login_backend(
			...
			Reporter.log(qaSales_V6.class.getSimpleName());
	...
	try{
		...
		Reporter.log(qaSales_V6.class.getSimpleName()+"-"+UserName_BackEnd+"- Springboard Login Passed");
		}catch(Exception e){
	...
	//	d1.findElement(By.id("sideMenuForm:REQ_SEARCH")).click();
		...
		WebElement f1 = d1.findElement(By.id("raspframe"));
			...
			Thread.sleep(1000);
			d1.findElement(By.xpath("//a[contains(text(),'JOB/1305345')]")).click();
			Thread.sleep(2000);
...
/*	@Test(priority = 13)
	...
	@DataProvider(name="salesQAV6-data-provider")
	public String[][] usernameAndPasswordDataProvider() {
		return ExcelReadUtil.readExcelInto2DArray("./salesqav6.xlsx","sales",5);
	}
}
