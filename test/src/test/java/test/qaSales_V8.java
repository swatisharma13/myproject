...
public static String javaScript = "var evObj = document.createEvent('MouseEvents');" +
	...
	@Test(dataProvider = "salesQAV8-data-provider", priority =1)
//	 @Test(priority =1)
	...
	// public static void login_backend() 
			...
			Reporter.log(qaSales_V8.class.getSimpleName());
	...
	Reporter.log(Environment);
			Reporter.log("Browser Version:"+caps.getVersion().toString());
			 WebDriverManager.chromedriver().setup();
			  d1 = new ChromeDriver();
			  d1.get("https://sales-qa.hrxtech.com.au/login");
	...
	d1.findElement(By.xpath("//input[@type='PASSWORD']")).sendKeys(Password_BackEnd);
		...
		Reporter.log(qaSales_V8.class.getSimpleName()+"-"+UserName_BackEnd+"- Springboard Login Passed");
			}catch(Exception e){
	...
	@Test(priority = 2, enabled = true)
	  public static void topMenuItems()
	     ...
	     try {
	        ...
	        //  d1.findElements(By.xpath("//a[contains(@class, 'ui-sidebar-close')]")).get(0).click();
	            d1.findElement(By.xpath("//div[contains(@class, 'searchBar')]/a[contains(@class, 'ui-sidebar-close')]")).click();
	         //   ui-icon ui-icon-closethick
	          //  a[href='#'][onclick='triggerRecent();']
	  ...
	  @Test(priority = 3)
		public static void jobs()
				...
				((JavascriptExecutor)d1).executeScript(javaScript, d1.findElement(By.xpath("//h2[normalize-space()='Dashboard']")));
		...
		d1.findElement(By.xpath("//a[contains(@href,'clientlov')]")).click();
			...
			d1.findElement(By.name("in_job_title")).sendKeys("Automation Test Job");
	...
	/*	@Test(priority = 6)
		...
		*/
		...
		public static void JobSearch() throws Exception {
			...
			Thread.sleep(1000);
			d1.findElement(By.id("JobGrid:searchForm:jobrefSuggestion_input")).sendKeys("JOB/1532007"); //-- FHL/1616159 - Test Test RTH
			Thread.sleep(1000);
	...
	*/
		...
		public static void delete_candidate(
			...
			try{
				  ...
				  searchButton.click();
				  WebElement searchInputBox  = d1.findElement(By.name("mainQuickSearch:quickSearchForm:quickSearchAutoComplete_input"));
				  searchInputBox.sendKeys("Backey Carter");
				  searchInputBox.sendKeys(Keys.ENTER);
				  Thread.sleep(3000);
				  Actions actions = new Actions(d1);
				 WebElement rightClick =  d1.findElement(By.id("candForm:candidateGrid:0:candidateSearchNamePanel_content"));
	...
	@DataProvider(name="salesQAV8-data-provider")
	public String[][] usernameAndPasswordDataProvider() {
		return ExcelReadUtil.readExcelInto2DArray("./salesqa8.xlsx","sales",5);
	}
}
