...
//	 @Test(priority =1)
	...
	// public static void login_backend() 
			...
			Reporter.log(qaSales_V7.class.getSimpleName());
	...
	Reporter.log(Environment);
			Reporter.log("Browser Version:"+caps.getVersion().toString());
			 WebDriverManager.chromedriver().setup();
			  d1 = new ChromeDriver();
			  d1.get("https://fantastic.qa.hrxtech.com.au/login");
	...
	d1.findElement(By.xpath("//input[@type='PASSWORD']")).sendKeys(Password_BackEnd);
		...
		Reporter.log(qaSales_V7.class.getSimpleName()+"-"+UserName_BackEnd+"- Springboard Login Passed");
			}catch(Exception e){
